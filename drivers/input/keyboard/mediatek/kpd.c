...
//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key begin
#ifdef CONFIG_AI_BSP_SOS_KEY
	#define ANT_KEY_INPUT_SOS		0x1F8
#endif
//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key end
...
static void kpd_keymap_handler(unsigned long data)
{
	...
	//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key begin		
			#ifdef CONFIG_AI_BSP_SOS_KEY
			if (linux_keycode == 102)
			linux_keycode = ANT_KEY_INPUT_SOS;
			#endif
	//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key end		
			...
			//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key begin	
			printk("(%s) linux_keycode = %d\n",(pressed == 1) ? "pressed" : "released",linux_keycode);
			//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key end
...
//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key begin
#ifdef CONFIG_AI_BSP_SOS_KEY
	__set_bit(ANT_KEY_INPUT_SOS, kpd_input_dev->keybit);
#endif
	__clear_bit(KEY_VOLUMEUP, kpd_input_dev->keybit);  //volumeup key used pmic
//Antai <AI_BSP_KEY> <luobowen> <2021-06-03> add for key end
