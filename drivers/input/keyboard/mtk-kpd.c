...
//Antai <AI_BSP_KEY> <hehl> <2021-11-17> add sos key for 1900 begin
#ifdef CONFIG_AI_BSP_SOS_KEY
	#define ANT_KEY_INPUT_SOS		0x1F8
#endif
//Antai <AI_BSP_KEY> <hehl> <2021-11-17> add sos key for 1900 end
...
//Antai <AI_BSP_KEY> <hehl> <2021-11-17> add sos key for 1900 begin
#ifdef CONFIG_AI_BSP_SOS_KEY
	input_set_capability(keypad->input_dev, EV_KEY, ANT_KEY_INPUT_SOS);
	__set_bit(ANT_KEY_INPUT_SOS, keypad->input_dev->evbit);
#endif
//Antai <AI_BSP_KEY> <hehl> <2021-11-17> add sos key for 1900 end
