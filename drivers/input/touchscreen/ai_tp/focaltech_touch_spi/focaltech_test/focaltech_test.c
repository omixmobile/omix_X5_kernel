...
//Antaiui <AI_BSP_CTP> <chenht> <2022-11-16> add tp test begin
...
static int fts_test_entry(char *ini_file_name)
{
    ...
    if (true == fts_test_start()) {
        FTS_TEST_SAVE_INFO("\n\n=======Tp test pass.\n");
        //Antaiui <AI_BSP_TP> <chenht> <2022-11-4> ctp detected begin
        //fts_ftest->result = true;
        ret = 1;
        //Antaiui <AI_BSP_TP> <chenht> <2022-11-4> ctp detected end
    } else {
        FTS_TEST_SAVE_INFO("\n\n=======Tp test failure.\n");
        //Antaiui <AI_BSP_TP> <chenht> <2022-10-29> ctp detected begin
...
//Antaiui <AI_BSP_TP> <chenht> <2022-10-29> ctp detected end



//Antaiui <AI_BSP_TP> <chenht> <2022-12-8> ctp detected begin
ssize_t fts_factory_show(
...
//Antaiui <AI_BSP_TP> <chenht> <2022-12-8> ctp detected end
