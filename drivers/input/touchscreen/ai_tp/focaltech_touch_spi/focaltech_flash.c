...
//Antaiui <AI_BSP_TP> <chenht> <2022-10-25> add for tp information begin
...
int fts_register_hardware_info(void)
{
    ...
    snprintf(ai_tp_hw_info.name, AI_DEVICE_NAME_LEN, "focaltech_touch_ft8057_FW[0x%02x]",fwver);
    ai_set_device_info(ai_tp_hw_info);
    return ret;
}
#endif
//Antaiui <AI_BSP_TP> <chenht> <2022-10-25> add for tp information end
