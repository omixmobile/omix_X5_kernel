...
int fts_test_i2c_read(u8 *writebuf, int writelen, u8 *readbuf, int readlen)
{
    ...
    ret = fts_read(writebuf, 1, readbuf, 1);
#else
...
int get_channel_num_focal(void)
{
    int ret = 0;
    u8 tx_num = 0;
    u8 rx_num = 0;
...
static int fts_test_main_init(void)
{
    ...
    /* <Antaiui> <AI_BSP_TP> <daicheng> <20180510> add for factory test begin */
...
#endif
    /* <Antaiui> <AI_BSP_TP> <daicheng> <20180510> add for factory test end */
...
TEST_ERR:
    //Antaiui <AI_BSP_CTP> <daicheng> <2018-06-30> Modify For #ASW1102A-3 begin
    fts_reset_proc(1);
    msleep(1*1000);
    //Antaiui <AI_BSP_CTP> <daicheng> <2018-06-30> Modify For #ASW1102A-3 End
    enter_work_mode();
    fts_test_main_exit();
...
//Antaiui <AI_BSP_CTP> <xuel> <2017-12-09> Modify For #ASW1102A-8 Begin
int ftxxxx_ftslibtest_sample(void)
{
   ...
   // struct i2c_client *client = ts_data->client;
    ...
    ret = write_reg(FTS_REG_VENDOR_ID, vendor_id);
    if(ret < 0) {
...
//Antaiui <AI_BSP_CTP> <xuel> <2017-12-09> Modify For #ASW1102A-8 End
