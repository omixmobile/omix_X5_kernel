...
static int fts_irq_registration(struct fts_ts_data *ts_data)
{
    ...
    printk("inter fts_irq_registration");
    ...
    printk("fts_irq_registration:%d",ret);
    tpd_gpio_as_int(ts_data->pdata->irq_gpio);
    printk("fts_irq_registration_gpio:%d",ts_data->pdata->irq_gpio);
