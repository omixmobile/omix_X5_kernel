        ...
        size_t txlen, u8 *rx, size_t rxlen)
{
    ...
    //Antai <AI_BSP_TP> <chenht> <2023-05-09> check unaligned_le16 begin
    //cts_err("CHT cmd check unaligned_le16, send = %04x , recv = %04x ", cmd_send, cmd_recv);
    //Antai <AI_BSP_TP> <chenht> <2023-05-09> check unaligned_le16 end
