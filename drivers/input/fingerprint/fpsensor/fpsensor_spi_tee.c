...
//#include "../../../tee/teei/400/common/include/tee_client_api.h"
//#include <teei_fp.h>
...
int fpsensor_check_HWID(fpsensor_data_t *fpsensor)
{
    ...
    if ((hwid == 0x7332) || (hwid == 0x7153) || (hwid == 0x7230) ||(hwid == 0x7222) ||(hwid == 0x7312) ||(hwid == 0x7319)  ||(hwid == 0x7339)) {
        match = 1;
    }
    return match;
}
...
#endif
{
...
#if defined(CONFIG_AI_BSP_MTK_DEVICE_CHECK)
	char fpc_id[3][20]={"fpsensor","null","null"};
	...
	snprintf(ai_fpc_hw_info.vendor, AI_DEVICE_VENDOR_LEN, "%s","HuaTe");
...
release_drv_data:
  fpsensor_debug(DEBUG_LOG,"fpsensor goto release_drv_data in driver 1\n");
...
static struct of_device_id fpsensor_of_match[] = {
    { .compatible = "mediatek,chipone_fpsensor", },
    {}
};
