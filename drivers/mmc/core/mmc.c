 ...
 */
//Antai <AI_BSP_DEVICECHECK> <luobowen> <2021-03-17> add for emmc begin
...
#endif
//Antai <AI_BSP_DEVICECHECK> <luobowen> <2021-03-17> add for emmc end
...
//Antai <AI_BSP_DEVICECHECK> <luobowen> <2021-03-17> add for emmc begin
#ifdef CONFIG_AI_BSP_MTK_DEVICE_CHECK
	sprintf(cidbuf, "%04X%04X%04X", card->raw_cid[0], card->raw_cid[1],card->raw_cid[2]);
	strcpy(ai_mydev_info.name, cidbuf);
