...
//Antai <AI_BSP_CAM> <lhh> <2022-09-01> camera porting for ASW2206 begin
...
#endif
//Antai <AI_BSP_CAM> <lhh> <2022-09-01> camera porting for ASW2206 end
...
#endif
#if defined(GC2385MICRO_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC2385MICRO_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_High, 1},
...
#endif
//Antai <AI_BSP_CAM> <lhh> <2022-09-01> camera porting for ASW2202 begin
...
#endif
//Antai <AI_BSP_CAM> <lhh> <2022-09-01> camera porting for ASW2202 end
