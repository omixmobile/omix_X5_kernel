...
//Antai <AI_BSP_CAM> <lhh> <2022-09-01> camera porting for ASW2206 end
#if 0
// Antaiui <AI_BSP_CAM> <xieht> <2021-01-15> 2002 camera poring begin
#if defined(S5K2T7SX_MIPI_RAW)
	{S5K2T7SX_SENSOR_ID,
	SENSOR_DRVNAME_S5K2T7SX_MIPI_RAW,
	S5K2T7SX_MIPI_RAW_SensorInit},
#endif
// Antaiui <AI_BSP_CAM> <xieht> <2021-01-15> 2002 camera poring end
...
#endif
//Antai <AI_BSP_CAM> <yaoyc> <2022-07-15> add for 2008PRO_BL sub camera ov5695 begin
#if defined(OV5695_MIPI_RAW)
	{OV5695_SENSOR_ID,
	SENSOR_DRVNAME_OV5695_MIPI_RAW,
	OV5695_MIPI_RAW_SensorInit},
#endif
//Antai <AI_BSP_CAM> <yaoyc> <2022-07-15> add for 2008PRO_BL sub camera ov5695 end
