...
static struct imgsensor_info_struct imgsensor_info = {
  ...
  .mipi_settle_delay_mode = 1, //0,MIPI_SETTLEDELAY_AUTO; 1,MIPI_SETTLEDELAY_MANNUAL
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,//SENSOR_OUTPUT_FORMAT_RAW_Gr, //sensor output first pixel color SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_R
	.mclk = 24,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
    ...
    { 4000, 3000, 160, 840, 7680, 4320, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080}, //hight speed video
    { 4000, 3000, 160, 840, 7680, 4320, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080}, // slim video
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {
	...
	{0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
	0x00, 0x2B, 0x1220, 0x0E9E, 0x01, 0x00, 0x0000, 0x0000,
	0x00, 0x30, 0x0274, 0x0BA0, 0x03, 0x00, 0x0000, 0x0000},
