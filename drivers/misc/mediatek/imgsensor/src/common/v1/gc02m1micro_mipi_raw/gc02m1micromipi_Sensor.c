...
#include "gc02m1micromipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1micro_camera_sensor"
#define LOG_1 LOG_INF("GC02M1MICRO, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1MICRO_SENSOR_ID,
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-23> ata check modify begin
	.checksum_value = 0x5622f670,
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-23> ata check modify end
	.pre = {
		.pclk = 84000000,
		.linelength = 2192,
		.framelength = 1276,
...
//Antaiui <AI_BSP_CAM> <yaoyc> <2020-12-01> add for 25571 android R camera hal request end
	...
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-23> sensor output format modify begin
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R, // SENSOR_OUTPUT_FORMAT_RAW_MONO,
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-23> sensor output format modify end
	.mclk = 24,
...
static kal_uint16 gc02m1micro_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
	char puSendCmd[I2C_BUFFER_LEN];
	kal_uint32 tosend, IDX;
	kal_uint16 addr = 0, addr_last = 0, data;
	//Antaiui <AI_BSP_CAM> <yaoyc> <2020-08-03> add for camera sensor reset i2c hw begin
    // kdInitI2cHw();
    //Antaiui <AI_BSP_CAM> <yaoyc> <2020-08-03> add for camera sensor reset i2c hw end
...
/* ANT_BSP_CAM xieht 20200803 add for vsdof begin */
...
/* ANT_BSP_CAM xieht 20200803 add for vsdof  end  */

static kal_uint16 gain2reg(const kal_uint16 gain)
{
	kal_uint16 reg_gain = gain << 4;

	if (reg_gain < GC02M1MICRO_SENSOR_GAIN_BASE)
		reg_gain = GC02M1MICRO_SENSOR_GAIN_BASE;
	else if (reg_gain > GC02M1MICRO_SENSOR_GAIN_MAX)
		reg_gain = GC02M1MICRO_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 GC02M1MICRO_AGC_Param[GC02M1MICRO_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0 },
		{  1536,  1 },
		{  2035,  2 },
		{  2519,  3 },
	...
	for (gain_index = GC02M1MICRO_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= GC02M1MICRO_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC02M1MICRO_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * GC02M1MICRO_SENSOR_DGAIN_BASE / GC02M1MICRO_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x1f);
	write_cmos_sensor(0xb2, temp_gain & 0xff);
	LOG_INF("GC02M1MICRO_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		GC02M1MICRO_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
static void sensor_init(void)
{
	...
	gc02m1micro_table_write_cmos_sensor(
...
UINT32 GC02M1MICRO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
