...
//Antaiui <AI_BSP_CAM> <yaoyc> <2020-12-01> add for 25571 android R camera hal request end
	...
	// Antaiui <AI_BSP_CAM> <xieht> <2022-03-11> frame sync add begin
	.frame_time_delay_frame = 1,
	// Antaiui <AI_BSP_CAM> <xieht> <2022-03-11> frame sync add end
	.ihdr_support = 0,
	.ihdr_le_firstline = 0,
	.sensor_mode_num = 5,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	//Antaiui <AI_BSP_CAM> <yaoyc> <2022-06-01> ASW2002 ASW2002PRO work arround dual camera ae abnormal begin
	//if(gain > 64*3)
	    //gain = gain/3;
	//else if(gain > 64*2)
	    //gain = gain/2;
	//Antaiui <AI_BSP_CAM> <yaoyc> <2022-06-01> ASW2002 ASW2002PRO work arround dual camera ae abnormal end
