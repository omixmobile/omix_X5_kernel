...
{ 2624, 1956,      0,    0, 2624, 1956, 1312,  978,      8,   4, 1296,  972,  4,    8, 1280,  960},  // Preview
 { 2624, 1956,      0,    0, 2624, 1956, 2624, 1956,     16,   6, 2592, 1944,  2,    2, 2560,  1920}, // capture
  { 2624, 1956,      0,    0, 2624, 1956, 2624, 1956,     16,   6, 2592, 1944,  2,    2, 2560,  1920},  // video
...
#else
 { 2592, 1944,     0,    0, 2592, 1944,  1296,  972,      0,   0, 1296,  972,  4,    8, 1280,  960},  // Preview
 { 2592, 1944,     0,    0, 2592, 1944, 2592, 1944,      0,   0, 2592, 1944,  0,    0, 2592,  1944}, // capture
 { 2592, 1944,     0,    0, 2592, 1944, 2592, 1944,      0,   0, 1296,  972,  4,    8, 1280,  960},  // video
 { 2592, 1944,     336,  432, 1920, 1080, 1920, 1080,     0,   0, 1920, 1080,  0,    0, 1920,  1080}, //hight speed video
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    write_cmos_sensor(0x3800, 0x00); // xstart = 0   0x10
    write_cmos_sensor(0x3801, 0x00); // xstart
    write_cmos_sensor(0x3802, 0x00); // ystart = 0   0x04
    write_cmos_sensor(0x3803, 0x00); // ystart
    write_cmos_sensor(0x3804, 0x0a); // xend = 2623
    write_cmos_sensor(0x3805, 0x3f); // xend   0x2f
    write_cmos_sensor(0x3806, 0x07); // yend = 1955
    write_cmos_sensor(0x3807, 0xa3); // yend   0x9C
