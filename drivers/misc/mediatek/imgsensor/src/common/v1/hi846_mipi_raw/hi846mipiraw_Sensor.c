...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
    ...
    { 3264, 2448, 1224, 918,  816,  612,  640,  480, 0, 0,  640,  480, 0, 0,  640,  480 }, // hight speed video
    { 3264, 2448,  352, 504, 2560, 1440, 1280,  720, 0, 0, 1280,  720, 0, 0, 1280,  720 },
};// slim video
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0006, 0x09DD);
	write_cmos_sensor(0x0008, 0x0ED8);
	...
	write_cmos_sensor(0x0074, 0x09D7);
	write_cmos_sensor(0x021C, 0x0001);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
		...
		write_cmos_sensor(0x002C, 0x09CF);
		write_cmos_sensor(0x005C, 0x2101);
		write_cmos_sensor(0x0006, 0x09DD); // frame_length_lines_h
		...
		write_cmos_sensor(0x0074, 0x09D7); // Coarse integration time
		write_cmos_sensor(0x021C, 0x0001);
		write_cmos_sensor(0x0A04, 0x014A);
		write_cmos_sensor(0x0418, 0x0000);
		write_cmos_sensor(0x0128, 0x0028);
...
{
//Antai <AI_BSP_CAM> <yaoyc> <2022-03-07> modify for ASW2200 can not read id when poweron begin
	*sensor_id = imgsensor_info.sensor_id;
	...
	return ERROR_NONE;
	*/
//Antai <AI_BSP_CAM> <yaoyc> <2022-03-07> modify for ASW2200 can not read id when poweron end
}
...
{
	LOG_INF("set_test_pattern_mode mode: %d", mode);
