...
static struct imgsensor_info_struct imgsensor_info = {
	...
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-03> sensor i2c addr modify begin
	.i2c_addr_table = {0x7e, 0xff},
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-03> sensor i2c addr modify end
};
...
static void gc5035_otp_update_wb(void)
{
	...
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-03> otp guide debug begin
	LOG_INF("pGolden->flag: %d\n", pGolden->flag);
	// Antaiui <AI_BSP_CAM> <xieht> <2021-02-03> otp guide debug end
