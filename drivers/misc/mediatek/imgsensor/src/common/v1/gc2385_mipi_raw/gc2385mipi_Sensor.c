...
//xuel <
    // Antaiui <AI_BSP_CAM> <xieht> <2020-12-04> add for frame sync begin
    .frame_time_delay_frame = 1,
    // Antaiui <AI_BSP_CAM> <xieht> <2020-12-04> add for frame sync end
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
            ...
            *feature_para_len=4;
            break;
// Antaiui <AI_BSP_CAM> <xieht> <2020-12-10> set_shutter_frame_length begin
        case SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME:
            set_shutter_frame_length((UINT16)(*feature_data), (UINT16)(*(feature_data + 1)));
            break;
// Antaiui <AI_BSP_CAM> <xieht> <2020-12-10> set_shutter_frame_length end
