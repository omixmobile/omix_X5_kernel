...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		//Antaiui <AI_BSP_CAM> <yaoyc> <20201201> add for 25571 android R camera hal request begin
		.mipi_pixel_rate = 67200000,
		//Antaiui <AI_BSP_CAM> <yaoyc> <20201201> add for 25571 android R camera hal request end
		.max_framerate = 300,
	},
	.cap = {
		.pclk = 84000000,
