...
//Antai <AI_BSP_LCM> <yaoyc> <2022-04-25> modify for fixed idle current test fail on ATA model begin
	lock_primary_wake_lock(1);
	//__pm_stay_awake(pri_wk_lock);
//Antai <AI_BSP_LCM> <yaoyc> <2022-04-25> modify for fixed idle current test fail on ATA model end
...
{
//Antai <AI_BSP_LCD> <hehl> <2022-04-21> add for lcm ata start 	
#if 1
	enum DISP_STATUS ret = DISP_STATUS_OK;
	...
	return false;
#endif	
//Antai <AI_BSP_LCD> <hehl> <2022-04-21> add for lcm ata end
}
