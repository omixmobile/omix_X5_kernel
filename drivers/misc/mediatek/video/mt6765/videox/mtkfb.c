...
//Antaiui <AI_BSP_LCD> <gaoxiaoxing> <20181011> add for ASW1102A-394, start
...
#endif
//Antaiui <AI_BSP_LCD> <gaoxiaoxing> <20181011> add for ASW1102A-394, end
...
//Antaiui <AI_BSP_LCD> <gaoxiaoxing> <20181011> add for ASW1102A-394, start
	...
	ai_mydev_info.ai_dev_type = AI_DEVICE_TYPE_LCD;	
#endif
//Antaiui <AI_BSP_LCD> <gaoxiaoxing> <20181011> add for ASW1102A-394, end
...
//Antaiui <AI_BSP_LCD> <gaoxiaoxing> <20181011> add for ASW1102A-394, start
#ifdef CONFIG_AI_BSP_MTK_DEVICE_CHECK
//Antai <AI_BSP_LCD> <hehl> <2020-12-31> add 1919 begin	
		lcm_drv=DISP_GetLcmDrv();
//Antai <AI_BSP_LCD> <hehl> <2020-12-31> add 1919 end			
		strcpy(ai_mydev_info.name, lcm_drv->name);
