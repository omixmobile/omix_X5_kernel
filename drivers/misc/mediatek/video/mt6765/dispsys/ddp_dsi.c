...
{
//AIUI <AIUI_BSP_LCD> <lihl> 20200210 add for lcd start 
#if 0
	DSI_OUTREG32(NULL, DISP_REG_CONFIG_MMSYS_LCM_RST_B, value);
#else
//AIUI <AIUI_BSP_LCD> <lihl> 20200210 add for lcd end 
...
//Antai <AI_BSP_LCD> <hehl> <2021-10-15> add lcm bias gpio interface begin
void lcm_set_power_pin (unsigned int pin ,unsigned int value)
{
	if (pin)
	{
		if (value)
...
//Antai <AI_BSP_LCD> <hehl> <2021-10-15> add lcm bias gpio interface end
...
//Antai <AI_BSP_LCD> <hehl> <2021-10-15> add lcm bias gpio interface begin
	utils->set_gpio_lcd_power = lcm_set_power_pin;
//Antai <AI_BSP_LCD> <hehl> <2021-10-15> add lcm bias gpio interface end
