...
//Antai <AI_BSP_CAM> <yaoyc> <2022-01-22> change flashlight current for ASW2008 begin 
/*
...
//50mA + 12.5mA*reg(6:0) *2
static const unsigned char mt6370_strobe_level[MT6370_LEVEL_FLASH] = {
	0x80, 0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0C, 0x0E, 0x10,
	0x12, 0x14, 0x16, 0x18, 0x1A, 0x1C, 0x10, 0x12, 0x14, 0x16,
	0x18, 0x1A, 0x1C, 0x1E, 0x20, 0x22, 0x24, 0x26, 0x28, 0x2A,
	0x2C, 0x2E
};
//Antai <AI_BSP_CAM> <yaoyc> <2022-01-22> change flashlight current for ASW2008 end
...
//Antaiui <AI_BSP_CAM> <yaoyc> <2022-01-22> modify for 2008 single flash led begin
	mt6370_en_ch2 = MT6370_DISABLE;
//Antaiui <AI_BSP_CAM> <yaoyc> <2020-01-22> modify for 2008 single flash led end
...
//Antaiui <AI_BSP_CAM> <yaoyc> <2022-01-22> modify for 2008 single flash led begin
	mt6370_en_ch2 = MT6370_DISABLE;
//Antaiui <AI_BSP_CAM> <yaoyc> <2022-01-22> modify for 2008 single flash led end
...
static ssize_t mt6370_strobe_store(struct flashlight_arg arg)
{
	...
	// Antaiui <AI_BSP_TORCH> <xieht> <2022-04-12> torch begin
	if (!arg.dur) {
		return 0;
	}
	// Antaiui <AI_BSP_TORCH> <xieht> <2022-04-12> torch end
	msleep(arg.dur);
	if (arg.decouple)
		mt6370_set_scenario(
