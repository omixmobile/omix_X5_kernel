...
#define AW36428_DTNAME "awinic,aw36428"
#endif
#ifndef AW36428_DTNAME_I2C
#define AW36428_DTNAME_I2C "awinic,aw36428"
#endif

#define AW36428_NAME "aw36428"
/* define registers */
...
#define AW36428_REG_TIMING_CONF      (0x0B)
...
//3rd_bk09 >
#define AW36428_PINCTRL_ENF_HIGH "aw_enable"
#define AW36428_PINCTRL_ENF_LOW  "aw_disable"

static struct pinctrl *AW36428_PINCTRL;
static struct pinctrl_state *aw36428_en_high;
static struct pinctrl_state *aw36428_en_low;

/******************************************************************************
 * Pinctrl configuration
 *****************************************************************************/
static int aw36428_pinctrl_init(struct platform_device *pdev)
{
	int ret = 0;

	/* get pinctrl */
	pr_err("3rd_bk09 devm_pinctrl_get ++\n");
	AW36428_PINCTRL = devm_pinctrl_get(&pdev->dev);
	if (IS_ERR(AW36428_PINCTRL)) {
		pr_err("Failed to get flashlight pinctrl.\n");
		ret = PTR_ERR(AW36428_PINCTRL);
		return ret;
	}
	pr_err("3rd_bk09 devm_pinctrl_get --\n");
	/* TODO: Flashlight XXX pin initialization */
	aw36428_en_high = pinctrl_lookup_state(AW36428_PINCTRL, AW36428_PINCTRL_ENF_HIGH);
	if (IS_ERR(aw36428_en_high)) {
		pr_err("Failed to init (%s)\n", AW36428_PINCTRL_ENF_HIGH);
		ret = PTR_ERR(aw36428_en_high);
	}
	aw36428_en_low = pinctrl_lookup_state(AW36428_PINCTRL, AW36428_PINCTRL_ENF_LOW);
	if (IS_ERR(aw36428_en_low)) {
		pr_err("Failed to init (%s)\n", AW36428_PINCTRL_ENF_LOW);
		ret = PTR_ERR(aw36428_en_low);
	}
 ...
 * aw36428 operations
 *****************************************************************************/
 // current = val * 1.46mA + 1.46mA
 /*
static const unsigned char aw36428_torch_level[AW36428_LEVEL_NUM] = {
	0x06, 0x10, 0x17, 0x1F, 0x27, 0x2F, 0x3B, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00};*/

static const unsigned char aw36428_torch_level[AW36428_LEVEL_NUM] = {
	0x10, 0x21, 0x32, 0x43, 0x54, 0x66, 0x77, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00};



//Antaiui <AI_BSP_CAM> <yaoyc> <20200624> modify for flashlight current begin

/*
static const unsigned char aw36428_flash_level[AW36428_LEVEL_NUM] = {
	0x01, 0x04, 0x05, 0x07, 0x09, 0x0B, 0x0D, 0x10, 0x14, 0x19,
	0x1D, 0x21, 0x25, 0x2A, 0x2E, 0x32, 0x37, 0x3B, 0x3F, 0x43,
	0x48, 0x4C, 0x50, 0x54, 0x59, 0x5D};*/
	
// current = val * 5.86mA + 5.86mA

static const unsigned char aw36428_flash_level[AW36428_LEVEL_NUM] = {
	0x03, 0x07, 0x0C, 0x10, 0x14, 0x19, 0x1D, 0x21, 0x25, 0x2A,
	0x2E, 0x32, 0x36, 0x3B, 0x3F, 0x43, 0x4C, 0x54, 0x5D, 0x65,
	0x6E, 0x76, 0x7F, 0x87, 0x98, 0xAF};


//{25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,450,500,550,600,650,700,750,800,850,900,950,1000,1050,1100};

//Antaiui <AI_BSP_CAM> <yaoyc> <20200624> modify for flashlight current end
...
//3rd_bk09 >
#ifdef CONFIG_AI_BSP_KERNEL_FLASHLIGHT
static ssize_t aw36428_torch_store(struct flashlight_arg arg)
{
	printk("%s: channel:%d, level:%d \n", __func__, \
		arg.channel, arg.level);

	aw36428_level_ch1 = arg.channel;
...
static ssize_t aw36428_gnstrobe_store(struct flashlight_arg arg)
{
	printk("%s: channel:%d, level:%d \n", __func__, \
		arg.channel, arg.level);
...
#ifdef CONFIG_AI_BSP_KERNEL_FLASHLIGHT_TEST
static ssize_t tlv_preflash_store(struct flashlight_arg arg)
{
	return 0;
}

static ssize_t tlv_mainflash_store(struct flashlight_arg arg)
{
	return 0;
}
#endif
