...
//Antaiui <AI_BSP_CAM> <lhh> <2022-09-30> otp porting begin
	{OV13853_SENSOR_ID, 0xA0, Common_read_region},
//Antaiui <AI_BSP_CAM> <lhh> <2022-09-30> otp porting end	
	{S5K3L8_SENSOR_ID, 0xA0, Common_read_region},
	...
	//Antaiui <AI_BSP_CAM> <dtw> <2022-02-23> s5kgm2sp pdaf porting begin
	{S5KGM2SP_SENSOR_ID, 0xA0, Common_read_region},
	{S5K2T7SX_SENSOR_ID, 0xA0, Common_read_region},
	//Antaiui <AI_BSP_CAM> <dtw> <2022-02-23> s5kgm2sp pdaf porting end
	//Antaiui <AI_BSP_CAM> <lhh> <2022-09-06> add for 2202 camera otp porting begin
	{S5KJN1SQ03_SENSOR_ID, 0xA0, Common_read_region},
	//Antaiui <AI_BSP_CAM> <lhh> <2022-09-06> add for 2202 camera otp porting end
