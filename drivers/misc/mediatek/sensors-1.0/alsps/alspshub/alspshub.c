...
{
// Antaiui <AI_BSP_SNS> <hehl> <2021-12-02> add for ps threshold begin
#if 0
	struct alspshub_ipi_data *obj = obj_ipi_data;
	...
	if (err < 0)
		return -1;
	threshold[0] = (data_t.proximity_t.threshold >> 16) & 0x0000FFFF;//16bit
	threshold[1] = (data_t.proximity_t.threshold >> 0) & 0x0000FFFF;//16bit
#endif 	
// Antaiui <AI_BSP_SNS> <hehl> <2021-12-02> add for ps threshold end
	return 0;
}
