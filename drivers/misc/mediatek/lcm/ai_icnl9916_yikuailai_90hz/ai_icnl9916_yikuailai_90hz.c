...
{0xC1,32,{0x10,0x20,0x20,0x96,0x04,0x30,0x30,0x04,0x4C,0x06,0x12,0x70,0x35,0x35,0x07,0x11,0x84,0x4C,0x00,0x93,0x18,0x8F,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
{0xC2,1,{0x00}},
...
{0xB2,32,{0x95,0x96,0x05,0x04,0xFF,0x22,0x10,0x0C,0x88,0x80,0x80,0x80,0x80,0x00,0x00,0x00,0x00,0x77,0x75,0x77,0x75,0x00,0x00,0x00,0x00,0x55,0x55,0x10,0x20,0x11,0x00,0x00}},
{0xB3,32,{0xF7,0x09,0x09,0x09,0x81,0x63,0x00,0x00,0x5D,0x00,0x00,0x00,0x08,0x44,0x0C,0x00,0x00,0x03,0x00,0x00,0x0C,0x00,0x00,0x03,0x00,0x00,0x55,0x55,0x55,0x55,0x55,0x55}},
...
{0xBC,32,{0x00,0x00,0x00,0x00,0x04,0x00,0xFF,0xF0,0x0B,0x33,0x50,0x49,0x33,0x33,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
...
{0xCA,32,{0x00,0x40,0x00,0x19,0x46,0x94,0x41,0x8F,0x44,0x44,0x50,0x50,0x5A,0x5A,0x64,0x64,0x32,0x32,0x11,0x00,0x01,0x01,0x0A,0x06,0x22,0x00,0x05,0x00,0x00,0x5A,0x5A,0x04}},
{0xFB,2,{0x54,0x54}},
...
//GAMMA
{0xC7,32,{0x73,0x10,0x01,0x23,0x45,0x67,0x77,0x77,0x30,0x73,0x10,0x01,0x23,0x45,0x67,0x77,0x77,0x30,0x31,0x00,0x01,0xFF,0xFF,0x40,0x18,0x18,0x43,0x00,0x00,0x00,0x00,0x00}},

//GAMMA 2.2
{0x80,32,{0xFF,0xFD,0xF8,0xF5,0xF1,0xEE,0xEB,0xE8,0xE5,0xDA,0xD1,0xC0,0xAD,0x9E,0x91,0x84,0x79,0x78,0x6D,0x62,0x55,0x4A,0x3E,0x2E,0x24,0x16,0x13,0x0F,0x0D,0x0A,0x07,0x04}},
{0x81,32,{0xFF,0xFD,0xF8,0xF5,0xF1,0xEE,0xEB,0xE8,0xE5,0xDA,0xD1,0xC0,0xAD,0x9E,0x91,0x84,0x79,0x78,0x6D,0x62,0x55,0x4A,0x3E,0x2E,0x24,0x16,0x13,0x0F,0x0D,0x0A,0x07,0x04}},
{0x82,32,{0xFF,0xFD,0xF8,0xF5,0xF1,0xEE,0xEB,0xE8,0xE5,0xDA,0xD1,0xC0,0xAD,0x9E,0x91,0x84,0x79,0x78,0x6D,0x62,0x55,0x4A,0x3E,0x2E,0x24,0x16,0x13,0x0F,0x0D,0x0A,0x07,0x04}},
{0x83,13,{0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00}},
{0x84,27,{0x0C,0xD0,0x68,0xE3,0x74,0xC0,0x32,0x24,0xE0,0x0C,0xD0,0x68,0xE3,0x74,0xC0,0x32,0x24,0xE0,0x0C,0xD0,0x68,0xE3,0x74,0xC0,0x32,0x24,0xE0}},
...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[0].vertical_frontporch = 1438; 
	...
	dfps_params[1].vertical_frontporch = 406; //371
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 1438; // 90hz:406 60hz：1438
	...
	params->dsi.PLL_CLOCK = 496;	//468 //432   /* this value must be in MTK suggested table 1378*/
...
#endif
//Antai <AI_BSP_LCD> <hehl> <20201204> add for lcm id ata end
	LCM_PRINT("ai_icnl9916_yikuailai_90hz kernel lcm_init\n");		
}

//Antai <AI_BSP_LCD> <chenht> <2023-02-16> modify for 2206 gesture begin
extern int is_gesture_mode_cts(void);
//Antai <AI_BSP_LCD> <chenht> <2023-02-16> modify for 2206 gesture end
...
// ---------------------------------------------------------------------------
struct LCM_DRIVER ai_icnl9916_yikuailai_90hz_lcm_drv =
{
	.name           = "ai_icnl9916_yikuailai_90hz",
