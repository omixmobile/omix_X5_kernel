...
#if defined(AI_ILI9883A_TRULY_60HZ)
extern struct LCM_DRIVER ai_ili9883a_truly_60hz_lcm_drv; 
#endif
//Antaiui <AI_BSP_TP> <hehl> <2021-08-03> modify for 2003 end
//Antai <AI_BSP_LCM> <luobowen> <2021-08-16> modify for 2003 begin	
#if defined(AI_ILI9883A_TRULY_90HZ)
extern struct LCM_DRIVER ai_ili9883a_truly_90hz_lcm_drv; 
#endif
//Antai <AI_BSP_LCM> <luobowen> <2021-08-16> modify for 2003 end
//Antaiui <AI_BSP_TP> <hehl> <2022-01-20> modify for 2200 begin
#if defined(AI_TRULY_NT36672C)
extern struct LCM_DRIVER ai_truly_nt36672c_lcm_drv; 
#endif
//Antaiui <AI_BSP_TP> <hehl> <2022-01-20> modify for 2200 end
//Antai <AI_BSP_LCD> <luobowen> <2021-01-28> add lcm start
#if defined(AI_NT36672C_90HZ)
extern struct LCM_DRIVER ai_nt36672c_90hz_lcm_drv;
#endif
//Antai <AI_BSP_LCD> <luobowen> <2021-01-28> add lcm end
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-13> add lcm for 2206 begin
#if defined(AI_TD4160_HUAXIAN_90HZ)
extern struct LCM_DRIVER ai_td4160_huaxian_90hz_lcm_drv;
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-13> add lcm for 2206 end
//Antaiui <AI_BSP_LCM> <chenht> <2022-07-25> add lcm for 2201 begin
#if defined(AI_TD4160_HUAXIAN_60HZ)
extern struct LCM_DRIVER ai_td4160_huaxian_60hz_lcm_drv;
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-07-25> add lcm for 2201 end
//Antaiui <AI_BSP_LCM> <chenht> <2022-09-15> add lcm for 2206 begin
#if defined(AI_FT8057_YIKUAILAI_90HZ)
extern struct LCM_DRIVER ai_ft8057_yikuailai_90hz_lcm_drv;
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-09-15> add lcm for 2206 end
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-12> add lcm for 2206 begin
#if defined(AI_FT8057_YIKUAILAI_60HZ)
extern struct LCM_DRIVER ai_ft8057_yikuailai_60hz_lcm_drv;
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-12> add lcm for 2206 end
//Antaiui <AI_BSP_LCM> <chenht> <2023-01-29> add lcm for 2206 begin
#if defined(AI_ICNL9916_YIKUAILAI_90HZ)
extern struct LCM_DRIVER ai_icnl9916_yikuailai_90hz_lcm_drv;
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2023-01-29> add lcm for 2206 end
//Antaiui <AI_BSP_LCM> <chenht> <2023-02-10> add lcm for 2202 begin
#if defined(AI_ICNL9916_YIKUAILAI_60HZ)
extern struct LCM_DRIVER ai_icnl9916_yikuailai_60hz_lcm_drv;
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2023-02-10> add lcm for 2202 end
struct LCM_DRIVER *lcm_driver_list[] = {
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-13> add lcm for 2206 begin
#if defined(AI_TD4160_HUAXIAN_90HZ)
	&ai_td4160_huaxian_90hz_lcm_drv,
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-13> add lcm for 2206 end
//Antaiui <AI_BSP_LCM> <chenht> <2022-07-25> add lcm for 2201 begin
#if defined(AI_TD4160_HUAXIAN_60HZ)
	&ai_td4160_huaxian_60hz_lcm_drv,
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-07-25> add lcm for 2201 end
//Antaiui <AI_BSP_LCM> <chenht> <2023-01-29> add lcm for 2206 begin
#if defined(AI_ICNL9916_YIKUAILAI_90HZ)
	&ai_icnl9916_yikuailai_90hz_lcm_drv,
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2023-01-29> add lcm for 2206 end
//Antaiui <AI_BSP_LCM> <chenht> <2023-02-10> add lcm for 2202 begin
#if defined(AI_ICNL9916_YIKUAILAI_60HZ)
	&ai_icnl9916_yikuailai_60hz_lcm_drv,
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2023-02-10> add lcm for 2202 end
//Antaiui <AI_BSP_TP> <hehl> <2022-01-20> modify for 2200 begin
#if defined(AI_TRULY_NT36672C)
    &ai_truly_nt36672c_lcm_drv,
#endif      
//Antaiui <AI_BSP_TP> <hehl> <2022-01-20> modify for 2200 end
//Antai <AI_BSP_LCM> <luobowen> <2021-08-16> modify for 2003 begin
#if defined(AI_ILI9883A_TRULY_90HZ)
	&ai_ili9883a_truly_90hz_lcm_drv,
#endif		
//Antai <AI_BSP_LCM> <luobowen> <2021-08-16> modify for 2003 end
//Antaiui <AI_BSP_TP> <hehl> <2021-08-03> modify for 2003 begin
#if defined(AI_ILI9883A_TRULY_60HZ)
	&ai_ili9883a_truly_60hz_lcm_drv,
#endif		
//Antaiui <AI_BSP_TP> <hehl> <2021-08-03> modify for 2003 end
//Antai <AI_BSP_LCD> <luobowen> <2021-01-28> add lcm start
#if defined(AI_NT36672C_90HZ)
	&ai_nt36672c_90hz_lcm_drv,
#endif
//Antai <AI_BSP_LCD> <luobowen> <2021-01-28> add lcm end
//Antaiui <AI_BSP_LCM> <chenht> <2022-09-15> add lcm for 2206 begin
#if defined(AI_FT8057_YIKUAILAI_90HZ)
	&ai_ft8057_yikuailai_90hz_lcm_drv,
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-09-15> add lcm for 2206 end
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-12> add lcm for 2206 begin
#if defined(AI_FT8057_YIKUAILAI_60HZ)
	&ai_ft8057_yikuailai_60hz_lcm_drv,
#endif
//Antaiui <AI_BSP_LCM> <chenht> <2022-10-12> add lcm for 2206 end
