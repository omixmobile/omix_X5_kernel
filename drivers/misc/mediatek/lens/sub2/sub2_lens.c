...
#endif
    // Antaiui <AI_BSP_CAM> <yaoyc> <20200724> add for sub2 af feature begin
    {1, AFDRV_DW9714AF, DW9714AF_SetI2Cclient, DW9714AF_Ioctl,
    DW9714AF_Release, DW9714AF_GetFileName, NULL},
    // Antaiui <AI_BSP_CAM> <yaoyc> <20200724> add for sub2 af feature end
};
...
//	printk("dantangwei_AFRegulatorCtrl\n");
	if (Stage == 0) {
		if (regVCAMAF == NULL) {
			...
			//	printk("dantangwei_AFRegulatorCtrl2\n");
				regVCAMAF =
			...
			//	printk("dantangwei_AFRegulatorCtrl3\n");
			//	printk("[Init] regulator_get %p\n", regVCAMAF);
...
{
	LOG_INF("Start\n");
	//printk("dantangwei_Register_AF_CharDrv\n");
			...
			const struct i2c_device_id *id)
{
	...
	LOG_INF("Start\n");
//	printk("dantangwei_AF_i2c_probe_Start\n");
...
{
//	printk("dantangwei_SUB2AF_i2C_init\n");
#if I2C_CONFIG_SETTING == 1
