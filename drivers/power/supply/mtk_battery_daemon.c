...
//Antaiui <AI_BSP_CHG> <hehl> <2021-03-22> modify mmi charger infomation begin
	...
	ret_value = gauge_get_int_property(GAUGE_PROP_BATTERY_CURRENT);
#else
...
//Antaiui <AI_BSP_CHG> <hehl> <2021-03-22> modify mmi charger infomation begin
#ifdef CONFIG_AI_BSP_MMITEST_CHGCUR
extern int g_ntc_status;
static ssize_t ntc_status_show(
	struct device *dev, struct device_attribute *attr, char *buf)
{
	bm_err("NTC status: %d\n", g_ntc_status);
	return sprintf(buf, "%u\n", g_ntc_status);
}
static ssize_t ntc_status_store(
	struct device *dev, struct device_attribute *attr,
	const char *buf, size_t size)
{
	return size;
...
//Antaiui <AI_BSP_CHG> <hehl> <2021-03-22> modify mmi charger infomation begin
#ifdef CONFIG_AI_BSP_MMITEST_CHGCUR
static DEVICE_ATTR_RW(ntc_status);
#endif
//Antaiui <AI_BSP_CHG> <hehl> <2021-03-22> modify mmi charger infomation end
...
//Antaiui <AI_BSP_CHG> <hehl> <2021-03-22> modify mmi charger infomation begin
#ifdef CONFIG_AI_BSP_MMITEST_CHGCUR
	ret = device_create_file(&(pdev->dev), &dev_attr_ntc_status);
	if (ret)
		goto _out;
#endif
//Antaiui <AI_BSP_CHG> <hehl> <2021-03-22> modify mmi charger infomation end
