...
/* gauge hal interface */
/* ============================================================ */
//Antaiui <AI_BSP_CHG> <hehl> <2021-02-22> add for battery mmi start
...
#endif
//Antaiui <AI_BSP_CHG> <hehl> <2021-02-22> add for battery mmi end
...
#if defined(CONFIG_AI_BSP_MTK_DEVICE_CHECK)
{
	...
	#if defined(MTK_MULTI_BAT_PROFILE_SUPPORT) && defined(AI_BATTERY_INFORMATION)
		strcpy(ai_mydev_info_bat.name, g_battery_id_information[gm.battery_id]);
	#elif defined(AI_BATTERY_INFORMATION)
		strcpy(ai_mydev_info_bat.name, g_battery_id_information);
	#else
		strcpy(ai_mydev_info_bat.name, "ANT-TIANM-5000MAH");
	#endif
