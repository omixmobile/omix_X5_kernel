...
//Antaiui <AI_BSP_CHG> <yixuhong> <20200317> add ntc_status begin
static int g_ntc_status = 1;
//Antaiui <AI_BSP_CHG> <yixuhong> <20200317> add ntc_status end
...
//Antaiui <AI_BSP_CHG> <yixuhong> <20200317> add for mmi test,charger voltage begin
#ifdef CONFIG_AI_BSP_MMITEST_CHGCUR
	POWER_SUPPLY_PROP_ChargerVoltage,
#endif
//Antaiui <AI_BSP_CHG> <yixuhong> <20200317> add for mmi test,charger voltage end	
};
	...
	union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_TEMP:
		...
		break;
	//Antaiui <AI_BSP_CHG> <hehl> <20201020> #24696 begin
	#ifdef CONFIG_AI_BSP_MMITEST_CHGCUR
	case POWER_SUPPLY_PROP_ChargerVoltage:

		val->intval = battery_get_vbus();//data->BAT_ChargerVoltage;
		break;
	#endif	
	//Antaiui <AI_BSP_CHG> <hehl> <20201020> #24696 end
						  ...
						  char *buf)
{
	...
	//Antaiui <AI_BSP_CHG> <yixuhong> <20200317> add for mmi test,charging current begin
	#ifdef CONFIG_AI_BSP_MMITEST_CHGCUR
	ret_value = battery_get_bat_current();
	#else
	ret_value = battery_get_bat_avg_current();
	#endif
	//Antaiui <AI_BSP_CHG> <yixuhong> <20200317> add for mmi test,charging current end
...
static DEVICE_ATTR(ntc_status, 0664, show_ntc_status, NULL);
//Antaiui <AI_BSP_CHG> <yixuhong> <20200317> add ntc_status end
...
//Antaiui <AI_BSP_CHG> <hehl> <20201021> add disable GM 3.0 define begin	
	...
	if (IS_ENABLED(CONFIG_POWER_EXT) || gm.disable_mtkbattery ||
		IS_ENABLED(CONFIG_MTK_DISABLE_GAUGE)) {
#endif
//Antaiui <AI_BSP_CHG> <hehl> <20201021> add disable GM 3.0 define end	
