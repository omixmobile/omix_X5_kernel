...
//Antaiui <AI_BSP_CHG> <hehl> <2022-04-19> delete print begin     
		...
		case CHARGER_UNKNOWN:
			...
			break;
//Antaiui <AI_BSP_CHG> <hehl> <2022-04-19> modify delete print end             
		default:
		break;
	}
	default:
...
extern void hl7019d_irq_disable_charging(void);
#endif
...
//Antaiui <AI_BSP_CHG> <hehl> <2022-03-28> modify for ASW2002 begin
#ifdef CONFIG_AI_BSP_CHARGER_IC_HL7015A
			hl7019d_irq_disable_charging();
#endif			
