...
//Antaiui <AI_BSP_CHG> <zhul> <2022-10-09> battery compatiable begin #huatiantong:367, #jiuliyuan adc_voltage:980
int g_battery_id_voltage[TOTAL_BATTERY_NUMBER] = {
        600, 1200, 1400, -1};
#if defined(CONFIG_AI_BSP_MULTI_BAT_SUPPORT)
	char g_battery_id_information[TOTAL_BATTERY_NUMBER][AI_DEVICE_NAME_LEN] =
    {
        {"ANT-HTT-5000MAH"},
        {"ANT-JLY-5000MAH"},
		{"ANT-TM-5000MAH"},
...
#else
	char g_battery_id_information[AI_DEVICE_NAME_LEN] = {"Battery information"};
#endif
//Antaiui <zhul> <2022-10-09> <2022-06-21> battery compatiable end
