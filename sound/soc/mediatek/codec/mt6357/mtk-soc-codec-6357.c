...
//Antai <AI_BSP_AUDIO> <yaoyc> <2022-02-08> add for ASW2200 audio begin
#if defined(CONFIG_SND_SOC_AW87XXX)
extern int aw87xxx_set_profile(int dev_index, char *profile);
#endif
//Antai <AI_BSP_AUDIO> <yaoyc> <2022-02-08> add for ASW2200 audio end
